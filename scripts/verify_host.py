...
def main():
    ...
    ap.add_argument('--route', type=Path, default=ROOT/'Configuration/replays/beginner-manual.json')
    ap.add_argument('--output', type=Path, default=ROOT/'build/validation/host')
    args = ap.parse_args()
    args.output.mkdir(parents=True, exist_ok=True)
    app = ROOT/'build/Daytona USA 2.app'
    binary = app/'Contents/MacOS/DaytonaUSA2'
